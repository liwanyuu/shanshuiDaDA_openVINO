...
def build_argparser():
    ...
    parser.add_argument("-l", "--cpu_extension",
                        help="MKLDNN (CPU)-targeted custom layers.Absolute path to a shared library with the kernels "
                             "impl.", type=str, default="/opt/intel/computer_vision_sdk/inference_engine/lib/ubuntu_16.04/intel64/libcpu_extension_avx2.so")
...
#    out_blob = next(iter(net.outputs))
    ...
    cv2.imwrite('results/Sketch2Shanshui/test_latest/images/draw_fake_B.png', img_bgr)
    cv2.waitKey(0)
